...
--
-- Table structure for table `productmaingroup_master`
--

CREATE TABLE `productmaingroup_master` (
  `productmaingroupId` int(50) NOT NULL,
  `productmaingroupName` varchar(50) DEFAULT NULL,
  `productmaingroupshortName` varchar(50) DEFAULT NULL,
  `description` varchar(255) DEFAULT NULL,
  `is_default` tinyint(4) DEFAULT '0',
  `is_on` tinyint(4) DEFAULT '1',
  `is_active` tinyint(4) DEFAULT '1',
...
--
-- Dumping data for table `productmaingroup_master`
--

INSERT INTO `productmaingroup_master` (`productmaingroupId`, `productmaingroupName`, `productmaingroupshortName`, `description`, `is_default`, `is_on`, `is_active`, `created_date`, `created_by`, `modified_date`, `modified_by`, `deleted_date`, `deleted_by`, `delete_remark`, `last_changed`) VALUES
(1, 'uuuuuu', 'v', 'awesome products with splendidi featrurs', 0, 1, 1, '2019-04-09 11:25:51', 1, NULL, NULL, NULL, NULL, NULL, '2019-04-09 09:25:51'),
(10, 'chagers', 'ss', 'ssss', 0, 1, 1, '2019-04-09 12:33:53', 1, NULL, NULL, NULL, NULL, NULL, '2019-04-09 10:33:53'),
(11, 'ss', 'ss', 'sdasdasd', 0, 1, 1, '2019-04-09 12:35:48', 1, NULL, NULL, NULL, NULL, NULL, '2019-04-09 10:35:48'),
(12, 'vivo', 'v', 'awesome', 0, 1, 1, '2019-04-09 12:54:12', 1, NULL, NULL, NULL, NULL, NULL, '2019-04-09 10:54:12'),
(13, 'battry', 'bt', 'good', 0, 1, 1, '2019-04-11 11:59:50', 1, NULL, NULL, NULL, NULL, NULL, '2019-04-11 09:59:50'),
(14, 'chagers', 'samung', 'awesome products with splendidi featrurs', 0, 1, 1, '2019-04-12 09:44:42', 1, NULL, NULL, NULL, NULL, NULL, '2019-04-12 07:44:42'),
(15, 'sds', 'sdfsdf', 'sdfsdfsdgdsgdf', 0, 1, 1, '2019-04-15 09:47:55', 1, NULL, NULL, NULL, NULL, NULL, '2019-04-15 07:47:55'),
(16, 'aaadddd', 'sa', 'awesome products with splendidi featrurs', 0, 1, 1, '2019-04-19 10:30:43', 1, NULL, NULL, NULL, NULL, NULL, '2019-04-19 08:30:43'),
(17, 'Apple', 'BAD', 'welkfnsdjkbf', 0, 1, 1, '2019-04-26 07:55:43', 1, NULL, NULL, NULL, NULL, NULL, '2019-04-26 05:55:43');
